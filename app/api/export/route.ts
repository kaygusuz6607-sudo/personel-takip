  ...
  try {
    ...
    if (type === "staff") {
      ...
      const data = staffs.map((s, idx) => ({
        ...
        "SGK / MEB Başlangıç": s.sgkStartDate ? s.sgkStartDate.toISOString().split("T")[0] : "-",
    ...
    if (type === "full") {
      ...
      const profileData = [
        ...
        { "Bilgi Alanı": "Resmî SGK / MEB Atama Tarihi", Değer: staff.sgkStartDate ? staff.sgkStartDate.toISOString().split("T")[0] : "-" },
